...
def intro_str():
    print("\n" + line_wrap1(center_wrap(header_str)))
    print("\n\n" + line_wrap3(center_wrap(welcome_str)))
    input(continue_str)
    print(textwrap.dedent("\n" + line_str1 + game_desc_str1))
    input(continue_str)
    print(textwrap.dedent("\n" + line_str1 + game_desc_str2))
    input(continue_str)
    print(textwrap.dedent("\n" + line_str1 + game_desc_str3))
    input(continue_str)
    print(textwrap.dedent("\n" + line_str1 + game_desc_str4))
    input(continue_str)
    print(textwrap.dedent("\n" + line_str1 + place_ships_str))
    input(continue_str)
